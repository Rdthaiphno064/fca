    ...
    var options = { 
        ...
        wsOptions: {
            headers: {
                ...
                'User-Agent': (ctx.globalOptions.userAgent || 'Mozilla/5.0 (Linux; Android 7.0; dolphin Build/NRD91N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.100 Safari/537.36'),
